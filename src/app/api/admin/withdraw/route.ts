...
export async function POST(request: NextRequest) {
  try {
    ...
    // Create withdrawal transaction (from customer to Halifax Bank)
    const transaction = new Transaction({
      fromUserId: customer._id,
      toUserId: halifaxBank._id,
    ...
    // Update customer balance (subtract withdrawal amount)
