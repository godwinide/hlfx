  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 mb-6">
        <h1 className="text-2xl font-bold text-white mb-6">Customer Withdrawal</h1>
        ...
        {success && (
          <div className="bg-green-500/10 border border-green-500/50 text-green-500 rounded-lg p-4 mb-6">
            <p className="font-semibold mb-2">Withdrawal Successful!</p>
            <div className="text-sm space-y-1">
              <p><strong>Amount:</strong> ${success.transaction.amount.toFixed(2)}</p>
              <p><strong>From:</strong> {success.transaction.fromUser.name} ({success.transaction.fromUser.accountNumber})</p>
